...
export default function OnboardingActionButton({
  ...
  return (
    <motion.button
      ...
      className={[
        "group relative mx-auto w-[270px] max-w-full overflow-hidden rounded-[24px] border px-5 py-4 text-center transition active:scale-[0.965]",
        config.shell,
        className,
      ].join(" ")}
    >
      <motion.div
        aria-hidden="true"
        className={[
          "pointer-events-none absolute left-[-35%] top-0 h-full w-[45%] bg-gradient-to-r blur-md",
          config.glow,
        ].join(" ")}
        animate={{ x: ["0%", "310%", "0%"] }}
      ...
      <div className="relative z-10 flex min-h-[54px] flex-col items-center justify-center">
