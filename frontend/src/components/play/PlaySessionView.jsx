...
export default function PlaySessionView({
  ...
  const isSplashStage =
    session?.status === "splash" || session?.status === "coming";
  ...
  return (
    <div className="fixed inset-0 z-[120] bg-[#030611] text-white">
      <div className="relative flex h-full w-full items-center justify-center overflow-hidden px-0 py-0">
        ...
        <div className="relative z-10 flex h-full w-full max-w-[430px] flex-col overflow-hidden border-x border-white/6 bg-[linear-gradient(180deg,rgba(6,10,18,0.98),rgba(4,8,14,1))] shadow-[0_0_0_1px_rgba(255,255,255,0.02),0_30px_120px_rgba(0,0,0,0.55)]">
