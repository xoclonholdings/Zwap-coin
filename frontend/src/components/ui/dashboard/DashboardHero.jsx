...
export default function DashboardHero({
  ...
  const hasDisplayName = Boolean(String(username || "").trim());
          ...
          <div className="min-w-0 flex-1">
            ...
            <div className="mt-2">
              ...
              {hasDisplayName ? (
                ...
                <h1 className="mt-1 text-[2rem] font-semibold leading-[1.05] tracking-[0.02em] text-white">
